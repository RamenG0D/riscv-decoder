...
pub fn decode_rtype(inst: InstructionSize) -> Result<InstructionDecoded> {
    ...
    match inst.opcode() {
        ...
        _ => Err(anyhow!(DecodeError::UnknownInstructionFormat {
            format: InstructionFormat::RType
        })),
    }
}
...
fn decode_single_precision(
    ...
    match (funct3, funct5) {
        ...
        (_, fcvt_w_s::FUNCT5) => match inst.rs2() {
            ...
            .context("Unknown Fcvt W S instruction"),
        },
...
pub fn decode_itype(inst: InstructionSize) -> Result<InstructionDecoded> {
    ...
    match iinst.opcode() {
        ...
        .context("Unknown I-Type instruction"),
    }
}
...
pub fn decode_stype(inst: InstructionSize) -> Result<InstructionDecoded> {
    ...
    match sinst.opcode() {
        STORE_MATCH => match sinst.funct3() {
            ...
            .context("Unknown S-Type instruction"),
        },
...
pub fn decode_utype(inst: InstructionSize) -> Result<InstructionDecoded> {
    ...
    match uinst.opcode() {
        ...
        .context("Unknown U-Type instruction"),
    }
}
...
pub fn decode_btype(inst: InstructionSize) -> Result<InstructionDecoded> {
    ...
    match binst.funct3() {
        ...
        .context("Unknown B-Type instruction"),
    }
}
...
pub fn decode_jtype(inst: InstructionSize) -> Result<InstructionDecoded> {
    ...
    match jinst.opcode() {
        ...
        .context("Unknown J-Type instruction"),
    }
}
...
pub fn try_decode(inst: InstructionSize) -> Result<InstructionDecoded> {
    ...
    let fmt = match inst & OPCODE_MASK {
        ...
        _ => {
            return Err(anyhow!(
                "Unknown instruction format for instruction {:#08X}",
                inst
            ))
        }
    };
...
decode_test!(
    ...
    InstructionDecoded::FcvtWD { rd: 10, rs1: 15 }
);
...
decode_test!(
    ...
    InstructionDecoded::FmvWX { rd: 0, rs1: 0 }
);

decode_test!(
    fcvt_d_s,
    0x42078753, /* fcvt.d.s f14, f15, rne */
    InstructionDecoded::FcvtDS { rd: 14, rs1: 15 }
);

decode_test!(
    fcvt_s_d,
    0x4017F7D3, /* fcvt.s.d f15, f15 */
    InstructionDecoded::FcvtSD { rd: 15, rs1: 15 }
);
